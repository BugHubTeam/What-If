...
<nav className="bg-gradient-to-r from-blue-400 via-violet-900 to-blue-500 w-full top-0 left-0">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-around mr-auto">
  <Link to="" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src={logo} className="" width={"80px"} alt="WhatIf Logo"/>
  ...
  <div className="justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex justify-center md:justify-between md:p-0 text-lg font-bold md:space-x-8 rtl:space-x-reverse nav-z">
